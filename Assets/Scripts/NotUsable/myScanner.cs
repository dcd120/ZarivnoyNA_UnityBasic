...
namespace EI2
{
    ...
    public class myScanner : MonoBehaviour
    {
        ...
        public myPlayerController Detect(Transform detector, bool useHeightDifference = true)
        {
            ...
            Vector3 toPlayer = myPlayerController.instance.transform.position - eyePos;
            Vector3 toPlayerTop = myPlayerController.instance.transform.position + Vector3.up * 1.5f - eyePos;
            ...
            if (toPlayerFlat.sqrMagnitude <= detectionRadius * detectionRadius)
            {
                    ...
                    Mathf.Cos(detectionAngle * 0.5f * Mathf.Deg2Rad))
                {
                    ...
                    if (canSee)
                        return myPlayerController.instance;
                }
            }
